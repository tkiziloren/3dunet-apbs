...
def main():
    ...
    for epoch in range(1, args.epochs+1):
        ...
        print(f'Epoch {epoch}/{args.epochs}', f'Train Loss: {train_loss:.4f}', f'Val Loss: {val_loss:.4f}', f'Val Dice: {val_dice:.4f}', f'Val IoU: {val_iou:.4f}')
