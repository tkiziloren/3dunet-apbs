...
class ResNet3D5L(nn.Module):
    def __init__(self, in_channels=2, out_channels=1, base_features=32):
        ...
        self.bottleneck = BasicBlock3D(base_features*16, base_features*32)
        self.dec1 = DecoderResNet3D(base_features*32 + base_features*16, base_features*16)
        self.dec2 = DecoderResNet3D(base_features*16 + base_features*8, base_features*8)
        self.dec3 = DecoderResNet3D(base_features*8 + base_features*4, base_features*4)
        self.dec4 = DecoderResNet3D(base_features*4 + base_features*2, base_features*2)
        self.dec5 = DecoderResNet3D(base_features*2 + base_features, base_features)
