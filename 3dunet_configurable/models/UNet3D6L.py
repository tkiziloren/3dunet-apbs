...
class UNet3D6L(nn.Module):
    def __init__(self, in_channels=2, out_channels=1, base_features=32):
        ...
        self.enc6 = Encoder(base_features * 16, base_features * 32)
        self.bottleneck = DoubleConv(base_features * 32, base_features * 64)
        self.dec1 = Decoder(base_features * 64 + base_features * 32, base_features * 32)
        self.dec2 = Decoder(base_features * 32 + base_features * 16, base_features * 16)
        self.dec3 = Decoder(base_features * 16 + base_features * 8, base_features * 8)
        self.dec4 = Decoder(base_features * 8 + base_features * 4, base_features * 4)
        self.dec5 = Decoder(base_features * 4 + base_features * 2, base_features * 2)
        self.dec6 = Decoder(base_features * 2 + base_features, base_features)
