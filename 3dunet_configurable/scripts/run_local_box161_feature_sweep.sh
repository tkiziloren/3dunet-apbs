...
OUTPUT_ROOT="${1:-/Users/tevfik/Sandbox/Tevfik/Projects/phd_examples/local_runs/3dunet_configurable_box161_feature_sweep}"
PYTHON_BIN="${PYTHON_BIN:-$CONFIGURABLE_DIR/../.venv/bin/python}"

CONFIGS=(
  "config/local/box161/box161_dataset_electrostatic_shape.yml"
  "config/local/box161/box161_dataset_electrostatic_shape_compact_chem.yml"
)
