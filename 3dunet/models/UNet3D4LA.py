...
class UNet3D4LA(nn.Module):
    def __init__(self, in_channels=2, out_channels=1, base_features=32):
        ...
        self.dec1 = DecoderAttention(base_features * 16, base_features * 8, base_features * 8)
        self.dec2 = DecoderAttention(base_features * 8, base_features * 4, base_features * 4)
        self.dec3 = DecoderAttention(base_features * 4, base_features * 2, base_features * 2)
        self.dec4 = DecoderAttention(base_features * 2, base_features, base_features)
